...
- **[Coolha DAPP↗](https://coolha.com)** 是运行在区块链网络上的应用程序
- **[Coolha DAO↗](https://snapshot.box/#/s:coolha.eth)** 用于 Coolha DAPP 的治理，由社区运营
- **[Coolha Limited↗](https://coolha.com/about_us)** 是开发智能合约和应用程序的主要技术服务团队